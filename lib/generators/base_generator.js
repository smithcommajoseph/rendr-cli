...
BaseGenerator = function BaseGenerator(generatorDir, generatorName, options, isCli) {
  ...
  this.isCli = typeof isCli === "undefined" ? true : isCli;
};
...
BaseGenerator.prototype.generate = function() {
  ...
  if ( !this.isCli ) {
    if ( this.renderCompanions() === false ) return;
  }
  this.postGenerate();
};
