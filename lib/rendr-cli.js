...
cli
  ...
  .option('-a, --apiHost <apiHost>', 'Set an apiHost (evaluated when generating a model or collection)')
...
cli.on('--help', function(){
  ...
  console.log('     g, generate <component> <name> [options]       Generate a model/view/controller/scaffold with <name>');
  console.log('     g, generate collection <modelName> [options]   Generate a collection with <modelName>');
